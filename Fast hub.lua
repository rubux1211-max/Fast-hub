...
local SG=Instance.new("ScreenGui",PG)SG.Name="FastHub"SG.ResetOnSpawn=false SG.IgnoreGuiInset=true
...
local HUBOPEN=false LOPEN=true
...
SPIN(ORR,10,function()return HUBOPEN end)PULSE(OH,0.75,0.55,1.2,function()return HUBOPEN end)PULSE(HALO,0.88,0.7,1.6,function()return HUBOPEN end)
showHub=function()hideLauncher()HUBOPEN=true MF.Visible=true HALO.Visible=true MF.Size=UDim2.new(0,0,0,0)TS:Create(MF,TweenInfo.new(0.35,Enum.EasingStyle.Back),{Size=UDim2.new(0,380,0,220)}):Play()end
-- ==== LAUNCHER ====
local LFH=Instance.new("Frame",SG)LFH.Size=UDim2.new(0,316,0,360)LFH.Position=UDim2.new(0.5,-158,0.4,-180)LFH.BackgroundColor3=AC LFH.BackgroundTransparency=0.88 LFH.BorderSizePixel=0 LFH.ZIndex=0
COR(LFH,16)STK(LFH,AC,1,0.75)
local LF=Instance.new("Frame",SG)LF.Size=UDim2.new(0,300,0,344)LF.Position=UDim2.new(0.5,-150,0.4,-172)LF.BackgroundColor3=BG LF.BackgroundTransparency=0.35 LF.BorderSizePixel=0 LF.Active=true LF.Draggable=true LF.ZIndex=1
...
local LTT=Instance.new("TextLabel",LH)LTT.Size=UDim2.new(0,110,1,0)LTT.Position=UDim2.new(0,34,0,0)LTT.Text="FAST HUB"LTT.TextColor3=TX LTT.BackgroundTransparency=1 LTT.Font=Enum.Font.GothamBlack LTT.TextSize=14 LTT.TextXAlignment=Enum.TextXAlignment.Left
GRAD(LTT,Color3.fromRGB(255,255,255),Color3.fromRGB(120,255,200),0)
local VP=Instance.new("Frame",LH)VP.Size=UDim2.new(0,36,0,18)VP.Position=UDim2.new(1,-72,0,11)VP.BackgroundColor3=AC COR(VP,9)
...
local LX=Instance.new("TextButton",LH)LX.Size=UDim2.new(0,24,0,24)LX.Position=UDim2.new(1,-30,0,8)LX.BackgroundColor3=OFF LX.BackgroundTransparency=0.3 LX.Text="X"LX.TextColor3=TX LX.Font=Enum.Font.GothamBold LX.TextSize=12 COR(LX,7)STK(LX,Color3.new(1,1,1),1,0.8)
local LC=Instance.new("Frame",LF)LC.Size=UDim2.new(1,-16,1,-96)LC.Position=UDim2.new(0,8,0,48)LC.BackgroundTransparency=1
...
local SF=Instance.new("Frame",GP)SF.Size=UDim2.new(1,0,0,40)SF.BackgroundColor3=OFF SF.BackgroundTransparency=0.35 SF.BorderSizePixel=0 COR(SF,10)STK(SF,Color3.new(1,1,1),1,0.85)
local SI=Instance.new("TextLabel",SF)SI.Size=UDim2.new(0,26,0,26)SI.Position=UDim2.new(0,7,0,7)SI.Text="🔍"SI.BackgroundTransparency=1 SI.TextSize=13
local SB=Instance.new("TextBox",SF)SB.Size=UDim2.new(1,-44,1,0)SB.Position=UDim2.new(0,34,0,0)SB.BackgroundTransparency=1 SB.PlaceholderText="Search games..."SB.PlaceholderColor3=DK SB.Text=""SB.TextColor3=TX SB.Font=Enum.Font.Gotham SB.TextSize=14 SB.TextXAlignment=Enum.TextXAlignment.Left SB.ClearTextOnFocus=false
local GBRow=Instance.new("Frame",GP)GBRow.Size=UDim2.new(1,0,0,48)GBRow.BackgroundColor3=FR GBRow.BackgroundTransparency=0.4 GBRow.BorderSizePixel=0 COR(GBRow,10)GRAD(GBRow,Color3.fromRGB(24,28,38),Color3.fromRGB(16,19,27),90)STK(GBRow,Color3.new(1,1,1),1,0.85)
local GBH=Instance.new("Frame",GBRow)GBH.Size=UDim2.new(0,22,0,22)GBH.Position=UDim2.new(0,13,0,13)GBH.BackgroundColor3=AC GBH.BackgroundTransparency=0.75 GBH.BorderSizePixel=0 COR(GBH,11)
local GD=Instance.new("Frame",GBRow)GD.Size=UDim2.new(0,12,0,12)GD.Position=UDim2.new(0,18,0,18)GD.BackgroundColor3=AC COR(GD,6)STK(GD,Color3.new(1,1,1),1,0.5)
local GBT=Instance.new("TextLabel",GBRow)GBT.Size=UDim2.new(1,-46,1,0)GBT.Position=UDim2.new(0,42,0,0)GBT.Text="+1 cut grass adventure"GBT.TextColor3=TX GBT.Font=Enum.Font.GothamBold GBT.TextSize=13 GBT.TextXAlignment=Enum.TextXAlignment.Left GBT.BackgroundTransparency=1
local GBO=Instance.new("TextButton",GBRow)GBO.Size=UDim2.new(1,0,1,0)GBO.BackgroundTransparency=1 GBO.Text=""GBO.BorderSizePixel=0 GBO.ZIndex=5
...
local LTABS=Instance.new("Frame",LF)LTABS.Size=UDim2.new(1,-16,0,38)LTABS.Position=UDim2.new(0,8,1,-42)LTABS.BackgroundTransparency=1
local BTL=Instance.new("TextButton",LTABS)BTL.Size=UDim2.new(0.5,-3,1,0)BTL.BackgroundColor3=AC BTL.Text="Games"BTL.TextColor3=BG BTL.Font=Enum.Font.GothamBold BTL.TextSize=13 COR(BTL,10)STK(BTL,Color3.new(1,1,1),1,0.6)
local BTI=Instance.new("TextButton",LTABS)BTI.Size=UDim2.new(0.5,-3,1,0)BTI.Position=UDim2.new(0.5,3,0,0)BTI.BackgroundColor3=OFF BTI.BackgroundTransparency=0.3 BTI.Text="Info"BTI.TextColor3=DK BTI.Font=Enum.Font.GothamBold BTI.TextSize=13 COR(BTI,10)
-- ==== LAUNCHER WIRING (no game code before this) ====
...
hideLauncher=function()LOPEN=false LF.Visible=false LFH.Visible=false end
showLauncher=function()LOPEN=true LF.Visible=true LFH.Visible=true end
closeAll=function()_G.FarmActive,_G.RebirthActive,_G.LootActive=false,false,false SG:Destroy()end
SB.TextChanged:Connect(function()local q=string.lower(SB.Text)GBRow.Visible=(q=="")or string.find("+1 cut grass adventure",q,1,true)~=nil end)
GBO.MouseButton1Click:Connect(function()if SB:IsFocused() then SB:ReleaseFocus() end showHub()end)
LX.MouseButton1Click:Connect(closeAll)
LX.MouseEnter:Connect(function()TS:Create(LX,TweenInfo.new(0.15),{BackgroundColor3=Color3.fromRGB(255,90,90),BackgroundTransparency=0}):Play()end)
LX.MouseLeave:Connect(function()TS:Create(LX,TweenInfo.new(0.15),{BackgroundColor3=OFF,BackgroundTransparency=0.3}):Play()end)
GBO.MouseEnter:Connect(function()TS:Create(GBRow,TweenInfo.new(0.12),{Size=UDim2.new(1,-4,0,48)}):Play()end)
GBO.MouseLeave:Connect(function()TS:Create(GBRow,TweenInfo.new(0.12),{Size=UDim2.new(1,0,0,48)}):Play()end)
